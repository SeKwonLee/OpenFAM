...
for num_threads_per_iter in 1 2 4 8 16 32 64
do
    for num_outstanding_reqs in 1 2 4 8 16 32 64 128 256
    do
        ...
        do
            ...
            do
                ...
                do
                    ...
                    for num_threads in $num_threads_per_iter
                    do
                        ...
                        do
                            ...
                            do
                                ...
                                then
                                    srun --nodelist=gtfama6 -p gtfamA numactl --membind=0,1,2,3 \
                                        $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                        ${io_size} 1 0 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} ${cache_page_size} \
                                ...
                                then
                                    srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                        $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                        ${io_size} 1 0.5 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} ${cache_page_size} \
                                        --gtest_filter=FamPutGet.${op_type} &>> \
                                        log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}_${cache_page_size}.txt
                                ...
                                then
                                    srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                        $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                        ${io_size} 1 0.99 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} ${cache_page_size} \
                                        --gtest_filter=FamPutGet.${op_type} &>> \
                                        log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}_${cache_page_size}.txt
                                else
                                    srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                        $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                        ${io_size} 0 0 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} ${cache_page_size} \
                                        --gtest_filter=FamPutGet.${op_type} &>> \
                                        log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}_${cache_page_size}.txt
                                fi
        ...
        do
            ...
            do
                ...
                do
                    ...
                    for cache_ratio in 0.0
                    do
                        printf "${cache_type} ${op_type} ${access_pattern} ${num_threads} ${num_outstanding_reqs} ${cache_ratio}\n" &>> log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}.txt
                        for io_size in 64 128 256 512 1024 2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152
                        do
                            cache_page_size=${io_size}
                            #cache_page_size=4096
                            ...
                            echo "========s======================================================"
                            echo "${cache_type}, ${op_type}, ${access_pattern}, ${io_size}, ${num_threads}, ${num_outstanding_reqs}, ${cache_ratio}, ${cache_page_size}"
                            echo "==============================================================="
                            ...
                            then
                                srun --nodelist=gtfama6 -p gtfamA numactl --membind=0,1,2,3 \
                                    $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                    ${io_size} 1 0 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} \
                                    ${cache_page_size} --gtest_filter=FamPutGet.${op_type} &>> \
                                    log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}.txt
                            elif [[ $access_pattern = "Zipf05" ]]
                            then
                                srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                    $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                    ${io_size} 1 0.5 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} \
                                    ${cache_page_size} --gtest_filter=FamPutGet.${op_type} &>> \
                                    log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}.txt
                            elif [[ $access_pattern = "Zipf099" ]]
                            then
                                srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                    $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                    ${io_size} 1 0.99 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} \
                                    ${cache_page_size} --gtest_filter=FamPutGet.${op_type} &>> \
                                    log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}.txt
                            else
                                srun --nodelist=gtfama6 -p gtfamA numactl --membind=0 \
                                    $BUILD_DIR/test/microbench/fam-api-mb/fam_microbenchmark_datapath2 \
                                    ${io_size} 0 0 ${num_threads} ${num_outstanding_reqs} ${cache_ratio} \
                                    ${cache_page_size} --gtest_filter=FamPutGet.${op_type} &>> \
                                    log_${cache_type}_${op_type}_${access_pattern}_${cache_ratio}.txt
                            fi
...
cmake .. -DLIBFABRIC_PATH=/opt/cray/libfabric/1.15.2.0 -DENABLE_LOCAL_CACHE=ON -DENABLE_LATENCY_CHECK=ON; make -j; make install
if [[ $? > 0 ]]
then
        echo "OpenFAM build with memoryserver version failed.. exit..."
        exit 1
